                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.debounce.500ms="firstName" type="text"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.debounce.500ms="lastName" type="text"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input wire:model.debounce.500ms="companyName" type="text"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input wire:model.debounce.500ms="companyEmail" type="email"
                                                class="form-control" id="company_email" placeholder=" ">
                                            @error('companyEmail')
                                                <div class="text-danger m-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input wire:model.debounce.500ms="companyPhone" type="text"
                                                class="form-control" id="company_phone" placeholder=" ">
                                            @error('companyPhone')
                                                <div class="text-danger m-1">{{ $message }}</div>
                                            @enderror
                                        </div>
